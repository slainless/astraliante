...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={ny(
      "bg-background-muted text-text-muted inline-flex h-10 items-center justify-center rounded-md p-1",
      className
    )}
    {...props}
  />

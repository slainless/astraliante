...
>(({ className, ...props }, ref) => {
  ...
  return (
    <div
      ...
      ref={ref}
      className={ny(
        "bg-bgc-muted absolute left-1.5 h-full w-px rounded-md py-3 duration-300 ease-in-out hover:bg-slate-300 rtl:right-1.5",
        className
      )}
      {...props}
    />
      ...
      >
        <AccordionPrimitive.Trigger
          className={ny(
            ...
            className,
            {
              "bg-bgc-muted rounded-md": isSelect && isSelectable,
      ...
      <AccordionPrimitive.Item value={value} className="relative">
        <AccordionPrimitive.Trigger
          ...
          className={ny(
            ...
            {
              "bg-bgc-muted": isSelected && isSelectable,
            },

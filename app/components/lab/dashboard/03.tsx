...
export function Dashboard03() {
  return (
    <div className="grid h-screen w-full pl-[56px]">
      <aside className="inset-y fixed  left-0 z-20 flex h-full flex-col border-r border-border-strong">
        <div className="border-b p-2 border-border-strong">
          <Button variant="outline" size="icon" aria-label="Home">
            <Triangle className="fill-text size-5" />
          </Button>
        </div>
          ...
          <Drawer>
            ...
            <DrawerContent className="max-h-[80vh]">
              ...
              <form className="grid w-full items-start gap-6 overflow-auto p-4 pt-0">
                <fieldset className="grid gap-6 rounded-lg border p-4 border-border-strong">
          ...
          <div className="bg-bgc-muted/50 relative flex h-full min-h-[50vh] flex-col rounded-xl p-4 lg:col-span-2">
            ...
            >
              ...
              <Textarea
                ...
                className="min-h-12 bg-transparent resize-none border-0 p-3 shadow-none focus-visible:ring-0"
              />

  ...
  return (
    <div className="bg-background flex min-h-screen w-full flex-col">
        ...
        <nav className="flex flex-col items-center gap-4 px-2 sm:py-5">
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <a
                href="#"
                className="text-text-muted hover:text-foreground flex size-9 items-center justify-center rounded-lg transition-colors md:size-8"
              >
      ...
      <div className="flex flex-col sm:gap-4 sm:py-4 sm:pl-14">
        <header className="bg-background-elevated-01 sticky top-0 z-30 flex h-14 items-center gap-4 border-b px-4 sm:static sm:h-auto sm:border-0 sm:bg-transparent sm:px-6">
          <Sheet>
            ...
            <SheetContent side="left" className="sm:max-w-xs">
              <nav className="grid gap-6 text-lg font-medium">
                <a
                  href="#"
                  className="bg-primary text-text-primary group flex size-10 shrink-0 items-center justify-center gap-2 rounded-full text-lg font-semibold md:text-base"
                >
                ...
                <a
                  href="#"
                  className="text-text-muted hover:text-foreground flex items-center gap-4 px-2.5"
                >
                  <Home className="size-5" />
                  Dashboard
                </a>

    ...
    <div className="flex min-h-screen w-full flex-col">
      ...
      <main className="bg-muted/40 flex min-h-[calc(100vh_-_theme(spacing.16))] flex-1 flex-col gap-4 p-4 md:gap-8 md:p-10">
        ...
        <div className="mx-auto grid w-full max-w-6xl items-start gap-6 md:grid-cols-[180px_1fr] lg:grid-cols-[250px_1fr]">
          <nav
            className="text-text-muted grid gap-4 text-sm"
            x-chunk="dashboard-04-chunk-0"
          >
            <a href="#" className="text-text-primary font-semibold">
              General
            </a>
            <a href="#">Security</a>
          ...
          <div className="grid gap-6">
            <Card x-chunk="dashboard-04-chunk-1">
              ...
              <CardFooter className="bg-background/50 border-t px-6 py-4">
                <Button>Save</Button>
              </CardFooter>
            </Card>
            <Card x-chunk="dashboard-04-chunk-2">
              ...
              <CardFooter className="bg-background/50 border-t px-6 py-4 rounded-b">
                <Button>Save</Button>
              </CardFooter>
            </Card>
          </div>
